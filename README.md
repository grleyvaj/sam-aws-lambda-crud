...
```bash
sam-aws-lambda-crud$ sam build --use-container
```
...
```bash
sam-aws-lambda-crud$ sam logs -n StockCheckerFunction --stack-name "sam-aws-lambda-crud" --tail
```
...
```bash
sam-aws-lambda-crud$ pip install -r tests/requirements.txt --user
# unit test
sam-aws-lambda-crud$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-aws-lambda-crud$ AWS_SAM_STACK_NAME="sam-aws-lambda-crud" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "sam-aws-lambda-crud"
```
